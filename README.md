...
本项目是使用vue-cli脚手架生成的项目，项目代码可以到我的github上clone下来。clone下来之后可进入文件目录
	...
	git clone https://github.com/mswuli/notepad.git
	cd notepad
	npm install
	npm run dev
...
关于vuex在该项目中更详细的应用可查看文章：[Vuex 模块化实现待办事项的状态管理]
...
虽然只是做了个小小的记事本，但是我感觉收获还是会很大的，很多知识点掌握得更加的牢固。这个记事本只做了一个页面，就没有用vue-router，路由也是vue里很强大的功能。
